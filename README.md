...
Falcon，隼，公认速度最快的动物。全称 ***Falcon Horizontal Line***，隼之视平线，取义不仅快且志存高远，我们的目标是努力让持续发布的进程更加顺滑与智能。
缩写FHL，可简称***风火轮***系统。

`奥琪科技（https://www.ooqi.cn）根据业务需要自行研发，提供高效交付效率的综合管理平台。平台集公有云（目前仅支持阿里云）资源管理，任务编排，工作流，版本控制，业务监控等功能。抽象底层资源，为开发，运维，测试，PM提供综合支撑能力。`
